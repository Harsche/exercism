...
int monthly_rate(double hourly_rate, double discount) {
    ...
    double total = apply_discount(before_discount, discount);
...
int days_in_budget(int budget, double hourly_rate, double discount) {
    ...
    int day_cost = daily_rate(hourly_rate);
    day_cost = apply_discount(day_cost, discount);
    int total_days = budget / day_cost;
    return (int)std::floor(total_days);
}
